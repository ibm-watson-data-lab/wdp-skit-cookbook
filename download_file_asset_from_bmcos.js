  ...
  function(callback) {
    ...
    */   
    ...
    function(callback) {
      ...
      */ 
      debug('Downloading data file from Bluemix Cloud Object Storage...');

      var params = {
        Bucket: project_info.storage_credentials.container, 
        Key: data_file_name, 
      };
      ...
      var config = {
          ...
          serviceInstanceId: 'crn:v1:bluemix:public:cloud-object-storage:global:a/908bf67ad8602999ea8c4fb3105b9cef:e102cbf7-3914-4f26-a2f2-ffea64638c86::',
      };
      ...
      cos.getObject(params, 
                    function(err, data) {
                      if(err) {
                        return callback('Error downloading ' + data_file_name + ' from container ' +  project_info.storage_credentials.container + ':' + data.statusCode + ' (' + data.message +')');                    
                      }
                      else {
